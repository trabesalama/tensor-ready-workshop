...
class APIClient:
    ...
    def query(self, question: str, prompt_name: Optional[str] = None, k: int = 5) -> Optional[Dict[str, Any]]:
    ...
    def test_similarity(self, query: str, k: int = 5) -> Optional[Dict[str, Any]]:
